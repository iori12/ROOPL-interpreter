...
type value =
  | IntVal of int
  | ObjVal of class_id * (string * int) list
  | LocsVal of int
...
type exp =
  ...
  | Minus of exp * exp
  | Xor of exp * exp
  | Times of exp * exp | Div of exp * exp | Mod of exp * exp
  | OpAnd of exp * exp | OpOr of exp * exp | And of exp * exp
  | Or of exp * exp | Greater of exp * exp | Less of exp * exp
  | Equal of exp * exp | NotEq of exp * exp | LessEq of exp * exp
  | GreaterEq of exp * exp
       
type statement =
  | AssignPl  of var * exp
  | AssignMin of var * exp
  | AssignXor of var * exp
  | Swap of var * var
